...
import de.robv.android.android.msposedBridge;
...
public class LSPosedBridge {
    ...
    public static class NativeHooker<T extends Executable> {
        ...
        public Object callback(Object[] args) throws Throwable {
            ...
            msposedBridge.LegacyApiSupport<T> legacy = null;
            ...
            if (!callback.isSkipped && legacySnapshot.length != 0) {
                ...
                legacy = new msposedBridge.LegacyApiSupport<>(callback, legacySnapshot);
                legacy.handleBefore();
            }
