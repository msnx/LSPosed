 ...
 */
public final class msposedHelpers {
    private msposedHelpers() {
    }
    ...
    public static Class<?> findClass(String className, ClassLoader classLoader) {
        if (classLoader == null)
            classLoader = msposedBridge.BOOTCLASSLOADER;
        try {
    ...
    public static XC_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        ...
        return msposedBridge.hookMethod(m, callback);
    }
     ...
     * methods, e.g. to override parameters only for the outer call. The msposed framework uses this
